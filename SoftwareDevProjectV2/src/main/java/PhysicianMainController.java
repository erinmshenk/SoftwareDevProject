...
public class PhysicianMainController implements Initializable {
    ...
    public PhysicianMainController(String nameFirst, String nameLast, String dob, String address, String zip, String ssn, String insurance, String phys,
    ...
    public PhysicianMainController()
    {
...
//Nurse Main Page Controller
    @FXML
    public void physicianSearchButton(ActionEvent event) throws IOException {
        ...
        if (firstName.equals("Adam")){
            Parent root = FXMLLoader.load(getClass().getResource("/fxml/PhysicianPatientFileDisplay.fxml"));
            stage = (Stage)((Node)event.getSource()).getScene().getWindow();
            scene = new Scene(root);
            stage.setScene(scene);
            stage.setTitle("Physician Display Patient File");
            stage.show();
        }
        else{
